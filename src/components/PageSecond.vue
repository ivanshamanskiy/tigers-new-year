    ...
    <div class="page-content">
            ...
            <div class="line line-outer-0">
                <div class="line line-outer-1">
                    <div class="corner-circle-1">
                        <img src="../images/icons/tiger-icon.svg" class="tiger-icon">
                    </div>
                        ...
                        <div class="line line-outer-3">
                            <div class="line line-outer-4">
                                <div class="small-circle-1">
                                    <img src="../images/icons/star-outline.svg" class="polar-star-icon" style="fill: var(--base-red)">
                                </div>
                                <div class="small-circle-2">
                                    <img src="../images/icons/star-outline.svg" class="polar-star-icon">
                                </div>
                                            ...
                                            <div class="line line-outer-8">
                                                <div class="line line-outer-9">
                                                    <div class="main-circle">
                                                        <img src="../images/icons/tiger-icon.svg" class="tiger-icon tiger-icon-main">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="wrapper-violet">
            <div class="button button-violet button-violet-shadow">
                <a href="#"><span class="text-color-violet">&larr; Узнать</span></a>
                <div class="quarter-smaller button-violet" id="quarter--1-1" ></div>
                <div class="quarter-bigger button-violet" id="quarter--1-2"></div>
                <div class="quarter-smaller button-violet" id="quarter--2-1"></div>
                <div class="quarter-bigger button-violet" id="quarter--2-2"></div>
                <div class="quarter-smaller button-violet" id="quarter--3-1"></div>
                <div class="quarter-bigger button-violet" id="quarter--3-2"></div>
                <div class="quarter-smaller button-violet" id="quarter--4-1"></div>
...
onMounted(() => {
    ...
    animate('.page-second', { opacity: ['0','1']}, { duration: 0.8, delay: 6.8 })
